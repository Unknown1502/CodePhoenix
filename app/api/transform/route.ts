      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Items Processed: \${items.length}',
            ...
            ElevatedButton(
              onPressed: isProcessing ? null : processItems,
              child: Text(isProcessing ? 'Processing...' : 'Process Item'),
            ),
            const SizedBox(height: 16),
            Expanded(
...
void main() {
  runApp(const MaterialApp(
    home: InventorySystem(),
  ));
}`
  }

  // Default fallback - return TypeScript
  return mockData.transformed
}
